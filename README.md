...
- All PRs need variable value updated (e.g., 1.2 → 1.3)
...
3. **Selective updates**: Updates the variable value (1.2 → 1.3) **only** in files that were originally changed in that PR
...
python update_prs.py --branches feature/branch1 feature/branch2 feature/branch3 --old-value 1.2 --new-value 1.3
...
python update_prs.py --branches feature/branch1 --main-branch master --old-value 1.2 --new-value 1.3

# Dry run with multiple branches
python update_prs.py --branches feature/branch1 feature/branch2 --old-value 1.2 --new-value 1.3 --dry-run
```
...
4. **Selective variable update**: Updates the variable value (1.2 → 1.3) only in the files that were originally changed
